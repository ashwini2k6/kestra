...
public final class VNodes {
    ...
    public static int computeTriggerVNode(final TriggerId id, int vNodeCount) {
        Objects.requireNonNull(id, "id cannot be null");
        return computeVNode(vNodeCount, FlowId.uidWithoutRevision(FlowId.of(id.tenant(), id.namespace(), id.flowId(), null)));
    }
    
    public static int computeFlowVNode(final FlowId id, int vNodeCount) {
        Objects.requireNonNull(id, "id cannot be null");
